        ...
        <td width="765" align="center" valign="top"><table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category.png"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="left"><span style="font-size:15px; font-weight:bold; color:#333333;">เว็บเพื่อนบ้าน</span></td>
                </tr>
            </table></td>
          </tr>
          <tr>
...
?>
                                  ...
                                  <tr>
                                    <td align="center"><input name="code3" type="text" id="code3" readonly="readonly" value="&lt;a href=&quot;http://<?=$titler[13];?>&quot; title=&quot;<?=$r2[0];?>&quot; target=&quot;_blank&quot;&gt;&lt;img src=&quot;http://<?=$titler[13];?>/banner/<?=$r2[1];?>&quot; title=&quot;<?=$r2[0];?>&quot; alt=&quot;<?=$r2[0];?>&quot; border=&quot;0&quot;&gt;&lt;/a&gt;" size="50" onclick="this.focus();this.select()" /></td>
                                  </tr>
                                  <tr>
                            ...
                            <tr>
                              <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <table width="330" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                      <td><form action="p-link.php" method="post" name="checkForm" id="checkForm" onsubmit="return check1()" style="height:230px;">
...
return true ;  
          ...
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr background="http://<?=$titler[13];?>/img/bg-title-category.png">
                  <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category.png"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left"><span style="font-size:15px; font-weight:bold; color:#333333;">เว็บเพื่อนบ้าน แบบBanner Link</span></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
	...
	?></td>
                ...
                <tr background="http://<?=$titler[13];?>/img/bg-title-category.png">
                  <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category.png"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left"><span style="font-size:15px; font-weight:bold; color:#333333;">เว็บเพื่อนบ้าน แบบText Link</span></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
