...
<title><?=$rcate[3];?></title>
<META NAME="keywords" CONTENT="<?=$rcate[5];?>"> 
<META NAME="description" CONTENT="<?=$rcate[4];?>">
        ...
        <td width="765" align="center" valign="top"><table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category.png"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="20" align="left"><img src="http://<?=$titler[13];?>/icon-menu/<?=$rcate[2];?>" width="16" height="16" /></td>
                <td width="730" align="left"><span style="font-size:15px; font-weight:bold; color:#333333;"><?=$rcate[1];?></span></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td align="center"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <?	
$strSQL="SELECT id, title, img, short_detail, view FROM `post` WHERE online = 'published' AND cate_id='$cate_id' ";
