  ...
  <tr>
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td><table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category-970.png"><table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><strong><font size="3" color="#333333">ข้อความ</font></strong></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <form action="p-edit-webboard.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                      <table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td height="20" align="left"><input name="title" type="text" id="title" style="width:950px;" value="<?=$rBOARD[3];?>" /></td>
                        </tr>
                        <tr>
		...
		?>
                              <option value="<?=$rcate[0];?>" <? if($cate_id==$rcate[0]){echo "selected";} ?>>
                              <?=$rcate[1];?>
                              </option>
                              <? } ?>
                            </select>
                              <input type="hidden" name="topic_id" id="topic_id" value="<?=$topic_id;?>" /></td>
                        </tr>
                        <tr>
                          <td height="20" align="left"><strong><font size="2">รายละเอียด</font></strong></td>
                        </tr>
                        <tr>
                          <td align="left"><textarea class="cleditorMain" id="input" name="input" style="width:950px; height:450px;"><?=$rBOARD[4];?></textarea></td>
                        </tr>
                        <tr>
                          <td height="20" align="left"><strong><font size="2">ไฟล์ภาพ
                            <input name="file1" type="file" id="file1" />
                                  <? if($rBOARD[5]!=""){?>
                                  <a href="http://<?=$titler[13];?>/webboard/board-img/<?=$rBOARD[5];?>" title="" target="_blank">คลิกที่นี่เพื่อดูภาพประกอบ</a>
                                  <input type="hidden" name="op" id="op" value="<?=$rBOARD[5];?>" />
                                  <? } ?>
