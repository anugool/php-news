          ...
          <td><table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category-970.png"><table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><strong><font size="3" color="#333333">แก้ไขข้อมูล RE :
                        <?=$rart[0];?>
                      </font></strong></td>
                    </tr>
                </table></td>
                ...
                <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <form action="p-edit-webboard-replay.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                      <table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="left"><textarea class="cleditorMain" id="input" name="input" style="width:950px; height:450px;"><?=$rre[0];?></textarea></td>
                        </tr>
                        <tr>
