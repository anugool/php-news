...
<title>เว็บบอร์ด กระดานถาม-ตอบ | <?=$titler[1];?></title>
<META NAME="keywords" CONTENT="<?=$titler[12];?>"> 
<META NAME="description" CONTENT="<?=$titler[1];?> เว็บบอร์ด กระดานถาม-ตอบ <?=$titler[11];?>">
              ...
              <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category-970.png"><table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="left"><span style="font-size:15px; font-weight:bold; color:#333333;">หมวดหมู่เว็บบอร์ด</span></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
...
?>
                        <tr>
                          <td width="760" height="20" align="left"><strong><font size="2"><img src="img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="http://<?=$titler[13];?>/wcate/<?=$rcate[0];?>/<?=$url?>.html" title="<?=$rcate[1];?>" target="_blank" style="color:#000000"><?=$rcate[1];?></a></font></strong></td>
...
?>
        ...
        <tr>
          <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="30" background="http://<?=$titler[13];?>/img/bg-title-webboard.png"><table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
...
?>
                                        ...
                                        <? } ?></td>
                                    <td width="650" align="left"><font size="2"><a href="http://<?=$titler[13];?>/board/<?=$objResult[0];?>/<?=$objResult[7];?>/<?=$url;?>.html" title="<?=$objResult[1];?>" target="_blank">
                                      <?=$objResult[1];?>
...
?>
                            ...
                            <tr>
                              <td height="20" align="left"><table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="10" align="left"><img src="img/arrow.gif" width="11" height="8" /></td>
                                    <td width="610" align="left"><font size="1">ตอบล่าสุดโดย
