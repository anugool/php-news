          ...
          <td><table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="30" background="http://<?=$titler[13];?>/img/bg-title-category-970.png"><table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><span style="color:#333333; font-size:16px; font-weight:bold; word-wrap:break-word;"><?=$rBOARD[3];?></span></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
...
echo $Num_Rows;
?>
                              <img src="http://<?=$titler[13];?>/webboard/img/ip.gif" width="15" height="14" />
                              <?=$rBOARD[9];?>
...
?>
            ...
            <table width="970" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="30" bgcolor="#999999"><table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
