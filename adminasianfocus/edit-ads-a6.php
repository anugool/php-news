...
$id=$_GET[id];
$s="SELECT * FROM `ads_a6` WHERE id='$id'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="ads-a6.php">จัดการข้อมูลโฆษณาตำแหน่ง A6 200 x 200 px</a> <img src="images/arrow.gif" width="7" height="11" /> </font><font color="#000000" size="2">แก้ไขตำแหน่งโฆษณา  A6</font></strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="p-ads-a6.php" enctype="multipart/form-data">
                      <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="500"><select name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                              ...
                              <option value="edit-ads-a6.php?type=1&amp;id=<?=$id;?>" <? if($type==1){ echo "selected"; }?>>Google Adsense</option>
                              <option value="edit-ads-a6.php?type=2&amp;id=<?=$id;?>" <? if($type==2){ echo "selected"; }?>>ผู้ลงโฆษณาทั่วไป</option>
                            </select>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table width="293" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center"><? if($r[2]==1){ ?>
                              <img src="../ads-img/<?=$r[9];?>" width="200" height="200" />
                              <? }else if($r[2]==2){ ?>
                              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="200" height="200">
                                ...
                                <embed src="../ads-img/<?=$r[9];?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="200" height="200"></embed>
                              </object>
                              <? } ?></td>
                        </tr>
                      </table>
