...
$s="SELECT * FROM `service_of_policies` WHERE id='1'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลนโยบายการให้บริการ</font></strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="p-service-of-policies.php">
                      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="left"><textarea class="cleditorMain" id="input" name="input" style="width:720px; height:450px;"><?=$r[1];?></textarea></td>
                        </tr>
                        <tr>
