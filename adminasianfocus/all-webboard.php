...
?>
                                  <tr>
                                    <td width="650" height="25" bgcolor="#FFFFFF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td align="left"><font size="2"><strong><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="../wcate/<?=$rcate[0];?>/<?=$url?>.html" title="<?=$rcate[1];?>" target="_blank">
                                            <?=$rcate[1];?>
                                          </a></strong></font></td>
                                        </tr>
                                    </table></td>
                                          ...
                                          <tr>
                                            <td height="20" align="left"><table width="300" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  ...
                                                  <td width="270" align="left"><font size="2"><strong><a href="../board/<?=$rwb[0];?>/<?=$rwb[5];?>/<?=$url;?>.html" title="<?=$rwb[1];?>" target="_blank">
                                                    <?=$rwb[1];?>
...
?>
								...
								?>
                                      ...
                                      <td width="170" align="center"><select name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                                          ...
                                          <option value="sticky.php?id=<?=$rwb[0];?>&amp;type=1">ถอนหมุด</option>
                                          <option value="edit-webboard.php?id=<?=$rwb[0];?>">แก้ไขข้อมูล</option>
                                          <option value="del-webboard.php?id=<?=$rwb[0];?>">ลบข้อมูล</option>
                                      </select></td>
                                    </tr>
                                    <? } ?>
                                </table></td>
...
?>
                                                      ...
                                                      <? } ?></td>
                                                  <td width="270" align="left"><font size="2"><strong><a href="../board/<?=$objResult[0];?>/<?=$objResult[5];?>/<?=$url;?>.html" target="_blank">
                                                    <?=$objResult[1];?>
                                                    </a></strong> <img src="../webboard/img/Logout.gif" width="16" height="16" />
                                                    <?=$objResult[4];?>
                                                  </font></td>
