        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลหมวดหมู่เว็บบอร์ด</font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: เพิ่มข้อมูลหมวดหมู่เว็บบอร์ด :: </strong></font></td>
                      </tr>
                      <tr>
                        <td><table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><form method="post" action="p-webboard-category.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                                  <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td align="right"><font size="2" color="#333333"><strong>หมวดหมู่เว็บบอร์ด</strong></font></td>
                                      <td width="10">&nbsp;</td>
                                      <td width="300" align="left"><input name="brand" type="text" id="brand" style="width:300px;" /></td>
                                    </tr>
                                    <tr>
...
return false ;
}else if(document.checkForm.member_id.value=="") {
alert("กรุณาเลือกผู้รับผิดชอบด้วยนะครับ") ;
...
return true ;
                      ...
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: รายการข้อมูลหมวดหมู่เว็บบอร์ด :: </strong></font></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">รายการข้อมูลหมวดหมู่เว็บบอร์ด ทั้งหมด
                                  <?=$Num_Rows;?>
                                  รายการ : แสดงผลหน้าละ
                                  <?=$Per_Page;?>
                                  รายการ จำนวนทั้งหมด
