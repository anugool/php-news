                          ...
                          <td><table width="580" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="330" align="left" valign="top"><font size="2" color="#333333"><strong>ภาพพื้นหลัง</strong></font>
                                    ...
                                    <br />
                                    <? if($r[2]!=""){ ?>
                                    <font size="2" color="#333333"><strong><a href="../bg-img/<?=$r[2];?>" target="_blank">คลิกที่นี่</a> เพื่อดูภาพพื้นหลัง หรือ <a href="del-bg.php?img=<?=$r[2];?>">ลบภาพพื้นหลัง</a> </strong></font>
                                    <? } ?></td>
                              </tr>
                          </table></td>
                        </tr>
