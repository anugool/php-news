                  ...
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="">
                      <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="200" align="left"><select name="type" id="type" style="width:190px; height:29px;">
                            <option value="1" selected="selected">รหัสสมาชิก</option>
                            <option value="2">ชื่อสมาชิก</option>
                                                                                </select>
                          </td>
                          <td width="460" align="left"><input name="keys" type="text" id="keys" value="" style="width:450px; height:29px;" /></td>
...
<table width="550" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
                      <tr bgcolor="#F7FDEE">
                        ...
                        <td width="225" height="28" align="center" bgcolor="#DDDDDD"><strong><font size="2">ชื่อ - สกุล </font></strong></td>
                      ...
                      <?
$strSQL="SELECT id, reg_date, name FROM `member` $where ";
...
?>
                      <tr>
                        ...
                        <td width="225" height="25" align="left" bgcolor="#F4F4F4">&nbsp;&nbsp;<font size="2"><? echo "$objResult[2]";?></font></td>
