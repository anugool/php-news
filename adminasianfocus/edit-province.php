        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="province.php">จัดการข้อมูลจังหวัด</a> <img src="images/arrow.gif" width="7" height="11" /> </font><font size="2" color="#333333"><strong>แก้ไขข้อมูลจังหวัด</strong></font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: แก้ไขข้อมูลจังหวัด :: </strong></font></td>
                      </tr>
                      <tr>
                                  ...
                                  <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="300" align="left"><select name="geo" id="geo">
                                          ...
                                          <?
								$ss="SELECT * FROM `geography`";
								$res=mysql_query($ss) or die("ERROR $s");
								while($rs=mysql_fetch_row($res)){
								?>
                                          <option value="<?=$rs[0];?>" <? if($rs[0]==$r[3]){ echo "selected";} ?>>
                                          <?=$rs[1];?>
                                          </option>
                                          <? } ?>
                                      </select></td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="10">&nbsp;</td>
                                      <td width="300" align="left"><input name="province" type="text" id="province" value="<?=$r[2];?>" />
                                          <input type="hidden" id="id" name="id" value="<?=$id;?>" /></td>
                                    </tr>
                                    <tr>
                                      <td width="150" align="right">&nbsp;</td>
                                      <td width="10">&nbsp;</td>
                                      <td width="300" align="left"><input type="submit" name="Submit" value="แก้ไขข้อมูล" />
                                      </td>
                                    </tr>
                                  </table>
...
function check1() {
if(document.checkForm.geo.value=="") {
alert("กรุณาเลือกภาคด้วยนะครับ") ;
document.checkForm.geo.focus() ;
return false ;
}else if(document.checkForm.province.value=="") {
alert("กรุณากรอกชื่อจังหวัดด้วยนะครับ") ;
...
return true ;
                      ...
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: รายการข้อมูลจังหวัด :: </strong></font></td>
                      </tr>
                      <tr>
                        <td><table width="550" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                            <tr>
                              <td width="50" height="30" align="center" valign="middle" bgcolor="#EFEFED"><span class="style4">รหัส</span></td>
                              <td width="150" align="center" valign="middle" bgcolor="#EFEFED"><font size="2" color="#333333"><strong>ข้อมูลภาค</strong></font></td>
