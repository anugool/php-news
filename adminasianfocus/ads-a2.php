...
$s="SELECT * FROM `ads_a2` WHERE id='1'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลโฆษณาตำแหน่ง A2 300 x 250 px</font></strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="p-ads-a2.php" enctype="multipart/form-data">
                      <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="500"><select name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                              ...
                              <option value="ads-a2.php?type=1" <? if($type==1){ echo "selected"; }?>>Google Adsense</option>
                              <option value="ads-a2.php?type=2" <? if($type==2){ echo "selected"; }?>>ผู้ลงโฆษณาทั่วไป</option>
                            </select>
                          </td>
                        </tr>
                      </table>
