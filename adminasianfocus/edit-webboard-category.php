...
$id=$_GET[id];
$s="SELECT * FROM `webboard_category` where id='$id'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="webboard-category.php">จัดการข้อมูลหมวดหมู่เว็บบอร์ด</a> <img src="images/arrow.gif" width="7" height="11" /> </font><font color="#000000" size="2">แก้ไขข้อมูลหมวดหมู่เว็บบอร์ด</font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: แก้ไขข้อมูลหมวดหมู่เว็บบอร์ด :: </strong></font></td>
                      </tr>
                      <tr>
                              ...
                              <td><form method="post" action="p-edit-webboard-category.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                                  <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="10">&nbsp;</td>
                                      <td width="300" align="left"><input name="brand" type="text" id="brand" value="<?=$r[1];?>" style="width:300px;" />
