...
?>
                  ...
                  <tr>
                    <td height="25"><table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="360" align="left"><strong><font size="2">[ <a href="edit-category.php?cate_id=<?=$cate_id;?>" style="color:#0000FF">แก้ไขหมวดหมู่</a> ] [ <a href="del-category.php?cate_id=<?=$cate_id;?>&op=<?=$rcate[1];?>" style="color:#0000FF" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}">ลบหมวดหมู่</a> ]</font></strong></td>
                      ...
                      <tr>
                        <td width="370" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="left"><font size="2"><a href="../p/<?=$objResult[0];?>/<?=$url;?>.html" style="color:#000000" target="_blank">
                                  <?=$objResult[2];?>
                                </a></font></td>
                              </tr>
                              <tr>
                            ...
                            <table width="120" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">
                                  <? if($objResult[6]==1){ echo "Comment ได้ทุกคน"; }else if($objResult[6]==2){ echo "เฉพาะสมาชิก"; }else if($objResult[6]==3){ echo "ไม่ให้ Comment"; }?>
                                </font></td>
                              </tr>
                          </table></td>
                        <td width="120" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <table width="120" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">
                                  <? $postDate=$objResult[7]; echo DateTime($postDate); ?>
                                </font></td>
                              </tr>
                          </table></td>
