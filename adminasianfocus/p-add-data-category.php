...
if(isset($file1)&&$file1!=""){
	...
	//insert
	$insert=mysql_query("INSERT INTO `post` (`cate_id` ,`title` ,`short_detail` ,`detail` ,`img` ,`status_comment` ,`post_date` ,`view` ,`online`)VALUES ('$cate_id', '$title', '$short_detail', '$detail', '$rename', '$status_comment', '$date', '0', '$online')") or die(mysql_error());
	//select
...
<? 		
	...
	//insert
	$insert=mysql_query("INSERT INTO `post` (`cate_id` ,`title` ,`short_detail` ,`detail` ,`status_comment` ,`post_date` ,`view` ,`online`)VALUES ('$cate_id', '$title', '$short_detail', '$detail', '$status_comment', '$date', '0', '$online')") or die(mysql_error());
	//select
	$spost="SELECT id FROM `post` ORDER BY id DESC LIMIT 0, 1";
	$repost=mysql_query($spost) or die("ERROR $spost");
	$rpost=mysql_fetch_row($repost);
