                    ...
                    <td><form action="p-edit-category.php" method="post" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
                      <table width="460" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td width="10" align="center">&nbsp;</td>
                          <td width="350" align="left">
						    <? if($rcate[2]!=""){ ?><img src="../icon-menu/<?=$rcate[2];?>" width="16" height="16" /><? } ?>
                            <input name="file1" type="file" id="file1" style="width:180px;" />
							<input type="hidden" name="op" id="op" value="<?=$rcate[2];?>" />
							 <font size="2" color="#FF0000">* รูปภาพขนาด 16 x 16 px</font></strong></td></tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td width="350" height="105" align="left" valign="top"><textarea name="title" id="title" style="width:330px; height:100px;"><?=$rcate[3];?></textarea></td>
                        </tr>
                        <tr>
                          <td width="100" height="105" align="right" valign="top"><strong><font size="2">Description</font></strong></td>
                          <td width="10" height="105" align="center" valign="top">&nbsp;</td>
                          <td width="350" height="105" align="left" valign="top"><textarea name="description" id="description" style="width:330px; height:100px;"><?=$rcate[4];?></textarea></td>
                        </tr>
                        <tr>
                          <td width="100" height="105" align="right" valign="top"><strong><font size="2">Keyword</font></strong></td>
                          <td width="10" height="105" align="center" valign="top">&nbsp;</td>
                          <td width="350" height="105" align="left" valign="top"><textarea name="keyword" id="keyword" style="width:330px; height:100px;"><?=$rcate[5];?></textarea></td>
                        </tr>
                        <tr>
                          <td width="100" align="right">&nbsp;</td>
                          <td width="10" align="center">&nbsp;</td>
