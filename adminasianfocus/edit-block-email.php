...
$id=$_GET[id];
$s="SELECT * FROM `block_email` where id='$id'";
        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="block-email.php">จัดการข้อมูล Block Email</a>  <img src="images/arrow.gif" width="7" height="11" /> แก้ไขข้อมูล Block Email </font></strong></td>
                  </tr>
                  <tr>
                    <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: แก้ไขข้อมูล Block Email :: </strong></font></td>
                      </tr>
                      <tr>
                        <td><table width="580" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><form method="post" action="p-edit-block-email.php" enctype="multipart/form-data" name ="checkForm" id="checkForm" onsubmit="return check1()">
...
return true ;
                      ...
                      <tr>
                        <td height="30"><font size="2" color="#333333"><strong>:: รายการข้อมูล Block Email :: </strong></font></td>
                      </tr>
                      <tr>
                        <td><table width="356" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#E9E9E6">
                            <tr>
                              <td width="250" height="30" align="center" valign="middle" bgcolor="#EFEFED"><strong><font color="#333333" size="2">Email</font></strong></td>
                              <td width="100" height="30" align="center" valign="middle" bgcolor="#EFEFED"><span class="style4">การกระทำ</span></td>
                            </tr>
                            <?	
		$strSQL = "SELECT * FROM block_email";
                      ...
                      <tr>
                        <td><table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center"><font size="2" color="#000000">รายการข้อมูล Block Email ทั้งหมด
                                  <?=$Num_Rows;?>
                                  รายการ : แสดงผลหน้าละ
                                  <?=$Per_Page;?>
                                  รายการ จำนวนทั้งหมด
