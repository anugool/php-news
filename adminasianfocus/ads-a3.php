              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="375" align="left"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูลโฆษณาตำแหน่ง A3 200 x 200 px</font></strong></td>
                          <td width="375" align="right"><strong><font color="#000000" size="2">[ <a href="add-ads-a3.php" style="color:#0000FF">เพิ่มตำแหน่งโฆษณา  A3</a> ]</font></strong></td>
                        </tr>
                      </table></td>
                  </tr>
                  <tr>
				  ...
				  ?>
                                ...
                                <td width="520" align="left" valign="top"><? if($objResult1[1]==1){?>
                                    <table width="520" border="0" align="center" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        <td align="left"><strong><font size="2"><a href="edit-ads-a3.php?id=<?=$objResult1[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads3.php?id=<?=$objResult1[0];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></strong></td>
                                      </tr>
                                    </table>
                                  <? }else if($objResult1[1]==2){ ?>
                                    <table width="520" border="0" align="center" cellpadding="0" cellspacing="0">
                                      ...
                                      <tr>
                                        ...
                                        <td width="10">&nbsp;</td>
                                        <td width="360" align="left"><font size="2"><a href="edit-ads-a3.php?id=<?=$objResult1[0];?>"><img src="images/edit.gif" width="40" height="15" border="0" /></a> <a href="del-ads3.php?id=<?=$objResult1[0];?>&amp;op=<?=$objResult1[9];?>" onclick="javascript:if(!confirm('ท่านต้องการลบข้อมูลจริงหรือไม่')){return false;}"> <img src="images/del.gif" width="40" height="15" border="0" /></a></font></td>
                                      </tr>
                                    </table>
                                  <? } ?>                                </td>
                              </tr>
