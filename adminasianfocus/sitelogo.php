        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> จัดการข้อมูล Site Logo </font></strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="p-site-logo.php" enctype="multipart/form-data">
                      <table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td align="center"><font size="2" color="#333333"><strong>Site Logo ควรมีขนาดไม่เกิน 720 x 90 px </strong></font></td>
                        </tr>
                        <tr>
                          <td align="center"><img src="../logo-img/<?=$rlogo[1];?>" width="250" height="90" /></td>
                        </tr>
                        <tr>
