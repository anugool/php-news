        ...
        <td bgcolor="#CCCCCC"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="760" align="center" valign="top" bgcolor="#FFFFFF"><table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="25"><strong><font size="2"><img src="../img/icon_bullet_arrow_small.gif" width="9" height="9" /> <a href="ads-a3.php">จัดการข้อมูลโฆษณาตำแหน่ง A3 200 x 200 px</a> <img src="images/arrow.gif" width="7" height="11" /> </font><font color="#000000" size="2">เพิ่มตำแหน่งโฆษณา  A3</font></strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" name="form1" method="post" action="p-add-ads-a3.php" enctype="multipart/form-data">
                      <table width="660" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="500"><select name="type" id="type" onchange="window.open(this.options[this.selectedIndex].value,'_self')">
                              ...
                              <option value="add-ads-a3.php?type=1" <? if($type==1){ echo "selected"; }?>>Google Adsense</option>
                              <option value="add-ads-a3.php?type=2" <? if($type==2){ echo "selected"; }?>>ผู้ลงโฆษณาทั่วไป</option>
                            </select>
                          </td>
                        </tr>
                      </table>
